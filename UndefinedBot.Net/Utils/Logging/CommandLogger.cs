...
public sealed class CommandLogger : BaseLogger
{
    ...
    internal CommandLogger(Microsoft.Extensions.Logging.ILogger<CommandLogger> rootLogger, string pluginName,
        string commandName, IEnumerable<string> tags)
    {
        ...
        Template = "[{Time}] [Command] " + $"[{_pluginName}/{_commandName}] {extendTemplate} " +
                   "[{LogLevel}] {Message}";
    }
